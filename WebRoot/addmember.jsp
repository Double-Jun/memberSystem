...
<body>
    <div id="all">
        ...
        <div id="content">
            <form action="MemberManagerServlet?method=addMember" method="post" enctype="multipart/form-data">
                <div class="content_left content" style="background:-yellow">
                    <ul>
                       <input type="hidden" name="id"  />
                        <li>
							<span>姓名</span><input type="text" name="name"  class="input1" id="input_name"/>
                ...
                <div class="content_right content">
                    <ul>
                        ...
                        <li>
							<span>毕业学校</span><input type="text" name="graduateSchool" value="${natureInfo.graduateSchool}" class="input1"/>
						</li>
                        <li>
							<span>在岗情况</span>
                ...
                <div class="save">
                    <div>
                        <span class="keep" style="border-radius:5px 0 0 5px;"><input type="submit" value="添加" /></span>
        ...
        <div id="footer">
        <span>Copyright &copy; 2003-2013 HEILONGJIANG UNIVERSITY. All
